...
console.log("Authors:", library[0].author, "&", library[1].author, "&", library[2].author);
console.log("Book names :", library[0].title, "&", library[1].title, "&", library[2].title);
console.log("reading status :", library[0].readingStatus, "&", library[1].readingStatus, "&", library[2].readingStatus);
...
console.log("Obj 1:", library1[0].author, "&", library1[0].libraryID, "&", library1[0].title);
console.log("obj 2 :", library1[1].author, "&", library1[1].libraryID, "&", library1[1].title);
console.log("obj 3 :", library1[2].author, "&", library1[2].libraryID, "&", library1[2].title);
